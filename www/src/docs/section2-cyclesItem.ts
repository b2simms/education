...
export const section2Cycles: Item[] = [
    {
        id: "item1",
        ...
        <p><a href="#_ftnref7" name="_ftn7">[7]</a> Blink, R. J. (2016). <em>Data-driven instructional leadership</em>. New York: Routledge.</p>`,
    },
    {
        id: "item2",
        name: "Annual Cycle",
        selected: false,
        content: html`<p>The first graphic on the previous page outlines the components of the PDCA cycle. The following are suggested major activities schools and districts could complete within the school year:</p>
        <ul>
        ...
        <li>the Annual School Performance Report will be shared with district personnel. These will identify school goals, progress toward these goals, and identified PL needs to promote ongoing improvement (see the template provided in %LINK_10% for details); and,</li>
    ...
    },
    {
        ...
        <p><a href="#_ftnref11" name="_ftn11">[11]</a> Breakspear, S. (2017). Embracing Agile Leadership for Learning - how leaders can create impact despite growing complexity. <em>Australian Educational Leader</em>, 39, 3, 68-71.</p>`,
    },
]
