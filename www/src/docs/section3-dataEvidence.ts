...
export const section3EvidenceItem: Item[] = [
    {
        ...
        <p><a href="#_ftnref12" name="_ftn12">[12]</a> Reeves, D. B. (2009). <em>Assessing educational leaders: Evaluating performance for improved individual and organizational results</em>. Thousand Oaks, Calif: Corwin Press.</p>`,
    },
]
